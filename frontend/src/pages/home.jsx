    ...
    return(
        <div className='font-poppins'>
          ...
          <div className="absolute mt-12 left-0 top-0 bg-black bg-opacity-60 h-full w-full text-center md:text-left">
                ...
                <p className='mx-10 my-4 text-white font-poppins md:mt-10 md:mx-16 '>We are delighted to welcome you to the our MTU Alumni community. 
          ...
          <div>
            <div className='flex py-14 px-10 items-center justify-center flex-col space-y-4 md:px-20 md:flex-row md:space-x-10 md:space-y-0'>
              <img className='w-11/12 md:w-1/3 shadow-md rounded-md shadow-gray-700' alt='alumniFotos' src={alumnniFotos}/>
