      ...
      <div className="mt-4 mx-auto flex flex-col-reverse space-y-1 md:flex-row items-center w-5/6 md:space-x-3 md:space-y-0 border border-gray-300 shadow-lg shadow-gray-400 rounded-lg md:w-[900px] md:h-[500px]">
        {/* img*/}
          <div className="hidden md:block md:w-[400px] md:h-full p-5 ">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7243.893661308951!2d93.9050324!3d24.7972741!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3749262a5adc967b%3A0x65df1fde96bcb382!2sManipur%20Technical%20University!5e0!3m2!1sen!2sin!4v1703759951766!5m2!1sen!2sin" width="100%" height="100%" style={{ border:0}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="mtuMap"></iframe>
        </div>
