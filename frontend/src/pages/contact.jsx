  ...
  return (
    <div className="mt-[54px]">
      <div className="relative h-96">
        <img src={phonePic}alt="contactPic" className="h-[500px] w-full bg-cover bg-center object-cover md:h-96"></img>
        <div className="absolute inset-0 p-16 md:p-32 bg-black bg-opacity-70 flex flex-col items-center h-[500px] z-20 space-y-4 md:h-96">
          <h1 className="text-white text-3xl font-bold text-center">Contact Us</h1>
          <p className="text-white text-center">Welcome to our Alumni Community! We're here to assist you and keep the lines of communication open.<br/> Whether you have questions, suggestions, or just want to reconnect, we're eager to hear from you.</p>
