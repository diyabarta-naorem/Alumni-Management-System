...
const MemberCard = () => {
    const batch = 2016;
  return (
      <div className=' relative rounded-lg h-80 w-72 font-poppins bg-white shadow-lg flex flex-col items-center space-y-3 py-2 hover:scale-95 transform duration-200'>
          ...
          <h1 className='text-xl text-white font-semibold'>Dextro Thoudam</h1>
